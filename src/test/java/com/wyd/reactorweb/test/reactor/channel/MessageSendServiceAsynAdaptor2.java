...
import com.wyd.reactorweb.test.reactor.service.impl.RemoteMessageSendServiceImpl2;
...
public class MessageSendServiceAsynAdaptor2 extends AsynRemoteServiceProxy<Boolean> {

    @Resource
    private RemoteMessageSendServiceImpl2 remoteMessageSendService;
